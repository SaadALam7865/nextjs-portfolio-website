        ...
        <header className="text-yellow-300 body-font">
          <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center">
            ...
            <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center justify-center  text-2xl gap-7 font-sans font-semibold animate-pulse">
              ...
              <div>
                <button className="flex ml-40  bg-pink-500  py-1 border-2 px-2 text-white hover:text-white border-pink-500  hover:border-white shadow-neonYellow hover:bg-pink-600 animate-none rounded-full">Download CV</button>
              </div>
            </nav>
          </div>
        </header>
